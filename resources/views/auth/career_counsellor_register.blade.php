...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Career Counsellor Register</title>
    ...
    <script type="text/javascript">
        ...
        <div class="flex-center position-ref full-height">
            ...
            @endif
               <div>
               <h4>Career Counsellor Register</h4>
               <form action="/cc/register/savedata" method="post"> 
               {{csrf_field()}}
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="coun_name">
