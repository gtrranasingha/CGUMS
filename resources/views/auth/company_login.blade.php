          ...
          <div class="row">
              ...
              <div class="card wow fadeIn" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="form-header blue-gradient">
                    <h3><i class="fas fa-landmark mt-2 mb-2"></i> C G U M S</h3>
                  </div>
                  <!--Error msg-->
                  <div class="col-md-12">
            ...
            <form action="/company/getdata" method="post"> 
                ...
                <div class="text-center">
                    <button  type="submit" class="btn blue-gradient btn-lg">Log In</button>
                </div>  
            </form>                
            </div>
                </div>
