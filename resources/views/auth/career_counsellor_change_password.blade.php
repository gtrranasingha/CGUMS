...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Career Counsellor Change Password</title>
    ...
    <script type="text/javascript">
        ...
        <div class="flex-center position-ref full-height">
            ...
            @endif
               ...
               <form action="/cc/career_counsellor_dashbord/update/change_password/savedata/{{$counsellor_user_data->id}}" method="post"> 
               {{csrf_field()}}
