        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-5 col-lg-6 col-md-10 col-sm-12 mx-auto mt-lg-5">
                  ...
                  <!--Header-->
                  <div class="card-body text-white peach-gradient mb-3" style="max-width: 50rem;">
                     <h3 class="card-title text-center"><b>Verification Unsuccessful</b></h3>
                      <p class="text-center"><i class="fas fa-times-circle fa-5x"></i></p>
                      <p class="card-text text-white text-center">Something went wrong!!<br>Please click <i>Try Again</i> to restart the verification</p>
                  
                   
                    <p class="text-center"><button  class="btn peach-gradient btn-lg "><a href="/request_register/sendemail/confirm">Try Again</a></button></p>
