...
<body class="fixed-sn white-skin">
        ...
        <ul class="custom-scrollbar">
          ...
          <li>
            <ul class="collapsible collapsible-accordion">
              ...
              <li><a href="file:///E:/New%20folder/Temp/Admin%20Dashboard%20Template/html%20-%20CGUMS/profile/basic-1%20-%20CGUMS.html" class="collapsible-header waves-effect arrow-r"><i
              ...
              <li><a href="../forms/extended.html" class="collapsible-header waves-effect arrow-r"><i
                    class="far fa-check-square"></i>Programmes</a>
              </li>
              <li><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-table"></i> Sessions<i
  ...
  <main>
              ...
              <div class="card text-center">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="padd" class="form-control form-control-sm">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="tadd" class="form-control form-control-sm">
                      ...
                      <label for="form5" class="">University e-mail address</label>
                            ...
                            <div class="row mb-5">
                              ...
                              <div class="col-md-6">
                                ...
                                <!-- Name -->
                                <select class="mdb-select md-form" id='sel_depart' name='sel_depart'>
                              ...
                              <div class="col-md-6">
                                ...
                                <!-- Name -->
                                <select class="mdb-select md-form" id='sel_emp' name='sel_emp'>
    ...
    <div class="text-center">
      <button class="btn aqua-gradient btn-lg">Submit</button>
    </div>
                   </div>
