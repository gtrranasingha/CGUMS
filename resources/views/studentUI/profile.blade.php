...
<body class="fixed-sn white-skin">
  ...
  <main>
    ...
    @php $id= Crypt::encrypt($pass->id); @endphp
          <form action="/welcome/profile/savedata/{{$id}}" method="POST" enctype="multipart/form-data">
          {{csrf_field()}}
            <!-- Section: Docs link -->
            <section class="pb-5">
              ...
              <div class="card text-center">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form5" class="form-control form-control-sm" name="first_name" value="{{ $pass->f_name}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form5" class="form-control form-control-sm" name="last_name" value="{{ $pass->l_name}}">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form12" class="form-control form-control-sm" name="per_email" value="{{ $pass->personal_email }}">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form3" class="form-control form-control-sm" name="mobile" value="{{ $pass->mobile  }}">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="form4" class="form-control form-control-sm" name="nic" value="{{ $pass->nic}}">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="padd" class="form-control form-control-sm" name="per_address" value="{{ $pass->per_address }}">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form form-sm mb-0">
                      <input type="text" id="tadd" class="form-control form-control-sm" name="mob_address" value="{{ $pass->mob_address}}">
                    ...
                    <div class="md-form form-sm mb-0">
                      ...
                      @enderror
                                ...
                                <option value='0'>-- Select Faculty --</option>
                                  ...
                                  @if($fact->id==$pass->faculty)
                                    <option value='{{ $fact->id }}' selected>{{ $fact->faculties}}</option>
                                  @else
                      ...
                      @enderror
                              ...
                              <div class="col-md-6">
                                ...
                                <!-- Name -->
                                <select class="mdb-select md-form"  name='gpa'  value="{{ $pass->gpa}}">
                                  <optgroup label="GPA">
                                    @if(1==$pass->gpa)
                      ...
                      <input type="file" class="custom-file-input" id="company logo" name="cv" value="{{ $pass->cv}}" accept=".pdf,.doc,application/msword"> 
                      <label class="custom-file-label" for="company logo" placeholder="Upload your CV here" >{{ $pass->cv }}</label>
                    </div>
                                      @error('cv')
                      <p style="text-align:left; color:red;"><small>{{ $message }}</small></p>
                      @enderror
                                                            ...
                                                            <div class="col-md-6 mb-4">
                                                                ...
                                                                <div class="md-form">
                                                                  ...
                                                                  <div class="custom-file">
                                                                <input type="file" class="custom-file-input" id="company logo" name="image" value="{{ $pass->image}}" accept="image/png, image/jpeg"> 
                                                                <label class="custom-file-label" for="company logo" placeholder="Upload your photo here" >{{ $pass->image }}</label>
                                                              </div>
                                                                    @error('image')
                                                                    <p style="text-align:left; color:red;"><small>{{ $message }}</small></p>
                                                                    @enderror
