    ...
    <section class="pb-5">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          ...
          <form action="/cc/career_counsellor_dashbord/noties/edit/{{$noties_data->id}}/save"  method="POST" enctype="multipart/form-data">
                @csrf
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="title" value="{{$noties_data->title}}">
            ...
            <div class="col-md-12">
              ...
              <div class="md-form md-outline">
                <textarea type="text" id="form101" class="form-control" rows="5"  name="description">{{$noties_data->note}}</textarea>
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="link1" value="{{$noties_data->link1}}">
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm"  name="link2" value="{{$noties_data->link2}}">
