  ...
  <div class="container-fluid">    
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            @if($data->confirmed==0)
            <a href="/cc/career_counsellor_dashbord/session/Career Counselling Session/select/{{$data->id}}" type="button" class="btn btn-primary btn-sm">Select</a>
            @else
            <a href="" type="button" class="btn btn-secondary btn-sm">Selected</a>
            @endif
            <a href="/cc/career_counsellor_dashbord/session/Career Counselling Session/remove/{{$data->id}}" type="button" class="btn btn-danger btn-sm">Remove</a>
          </td>
        </tr>
      @endforeach
      </tbody>
