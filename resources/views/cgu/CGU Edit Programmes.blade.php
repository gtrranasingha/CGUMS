  ...
  <div class="container-fluid">
    ...
    <section class="pb-5">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
        <form action="/cc/career_counsellor_dashbord/programme/edit/savedata/{{$programme_data->id}}" method="post">
                          @csrf
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="name" value="{{$programme_data->P_name}}">
            ...
            <div class="col-md-6">
              ...
              <select class="mdb-select md-form"  name="type" value="{{$programme_data->P_type}}">
                @if($programme_data->P_type=="Career Development")
                <option value="" >Select Programme Type</option>
                  ...
                  @elseif($programme_data->P_type=="Entrepreneurship Skills Development")
                  <option value="" >Select Programme Type</option>
                  ...
                  <option value="Team Builidng">Team Builidng</option>
                  <option value="Public Speaking">Public Speaking</option>
                  @elseif($programme_data->P_type=="Leadership Training")
                  <option value="" >Select Programme Type</option>
                  <option value="Career Development" >Career Development</option>
                  <option value="Entrepreneurship Skills Development">Entrepreneurship Skills Development</option>
                  ...
                  <option value="Team Builidng">Team Builidng</option>
                  <option value="Public Speaking">Public Speaking</option>
                  @elseif($programme_data->P_type=="Soft Skills Development")
                  <option value="" >Select Programme Type</option>
                  <option value="Career Development" >Career Development</option>
                  <option value="Entrepreneurship Skills Development">Entrepreneurship Skills Development</option>
                  <option value="Leadership Training">Leadership Training</option>
                  ...
                  <option value="Team Builidng">Team Builidng</option>
                  <option value="Public Speaking">Public Speaking</option>
                  @elseif($programme_data->P_type=="Team Builidng")
                  <option value="" >Select Programme Type</option>
                  <option value="Career Development" >Career Development</option>
                  <option value="Entrepreneurship Skills Development">Entrepreneurship Skills Development</option>
                  <option value="Leadership Training">Leadership Training</option>
            ...
            <div class="col-md-4">
              ...
              <div class="md-form form-sm mb-0">
                <input placeholder="Selected date" type="text" id="date-picker-example" class="form-control datepicker"  name="date" value="{{$programme_data->P_date}}"> 
            ...
            <div class="col-md-4">
              ...
              <div class="md-form form-sm mb-0">
                <input type="time" id="default-picker" class="form-control" placeholder="Select time" name="time" value="{{$programme_data->P_time}}">
            ...
            <div class="col-md-4">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="venue" value="{{$programme_data->P_venue}}">
            ...
            <div class="col-md-12">
              ...
              <div class="md-form md-outline">
                <textarea type="text" id="form101" class="form-control" rows="3" name="details">{{$programme_data->P_details}}</textarea>
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="resource_person" value="{{$programme_data->P_resourceperson}}">
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="number" id="tadd" class="form-control form-control-sm" name="capacity" value="{{$programme_data->capacity}}">
