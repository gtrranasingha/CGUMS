  ...
  <div class="container-fluid">
    ...
    <section class="pb-5">
      ...
      <div class="card text-center">
        <h3 class="card-header purple-gradient white-text">Add New Notice</h3>
        <div class="card-body">
          <div class="row">
          ...
          <form action="/cc/career_counsellor_dashbord/noties/addnew/save"  method="POST" enctype="multipart/form-data">
                @csrf
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="title">
            ...
            <div class="col-md-12">
              ...
              <div class="md-form md-outline">
                <textarea type="text" id="form101" class="form-control" rows="5"  name="description"></textarea>
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm" name="link1">
            ...
            <div class="col-md-6">
              ...
              <div class="md-form form-sm mb-0">
                <input type="text" id="tadd" class="form-control form-control-sm"  name="link2">
            ...
            <div class="col-md-12">
              ...
              <div class="custom-file">
                ...
                <label class="custom-file-label" for="company logo">Upload Attachment[Maximum File Size -
                  2MB] - (Optional) </label>
                  @error('attachment')
                      <p style="text-align:left; color:red;"><small>{{ $message }}</small></p>
                @enderror
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <br>
          <div class="text-center">
            <button type="submit" class="btn purple-gradient ">Submit</button>
          </div>
          </form>
        </div>
