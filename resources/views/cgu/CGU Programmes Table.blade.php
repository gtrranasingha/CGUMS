...
<main>
  <div class="container-fluid">    
      <div class="col-md-12">
        <div class="text-center">
         <a href="/cc/career_counsellor_dashbord/programme/addnew"> <button class="btn btn-unique">+ Add New Programme</button></a>
        </div>
      </div>
      ...
      <tbody>
        ...
        <tr>
          <td>{{$data->P_date}} {{$data->P_time}}</td>
          <td>{{$data->P_name }}</td>
          <td> <a href="/cc/career_counsellor_dashbord/programme/enrollment/{{$data->id}}"><button>View</button></a></td>
          <td>
          <a href="/cc/career_counsellor_dashbord/programme/show/{{$data->id}}"> <button type="button" class="btn btn-unique btn-rounded btn-sm px-2 m-0 col-md-3" title="VIEW"><i class="far fa-eye"></i></button></a>
          <a href="/cc/career_counsellor_dashbord/programme/edit/{{$data->id}}"> <button type="button" class="btn btn-blue btn-rounded btn-sm px-2 m-0 col-md-3" title="EDIT"><i class="far fa-edit"></i></button></a>
          <a href="/cc/career_counsellor_dashbord/programme/delete/{{$data->id}}"> <button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-3" title="DELETE"><i
              class="far fa-trash-alt"></i></button></a></td>
        </tr>
       @endforeach
      </tbody>
    </table>
