...
<main>
  <div class="container-fluid">    
      <div class="col-md-12">
        <!-- <div class="text-center">
          <button class="btn btn-blue">+ Register New Company</button>
        </div> -->
      </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/cc/career_counsellor_dashbord/company/view/deactive/{{$company->id}}"><button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-10">Deactivate</button></a>
            @else
            <a href="/cc/career_counsellor_dashbord/company/view/active/{{$company->id}}"><button type="button" class="btn btn-primary btn-rounded btn-sm px-2 m-0 col-md-10">activate</button></a>
            @endif
          </td>
        </tr>
        @endforeach
