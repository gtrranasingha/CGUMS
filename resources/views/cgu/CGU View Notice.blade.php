    ...
    <section class="pb-5">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          ...
          <h4 class="h3-responsive text-center font-weight-bold dark-grey-text">{{$noties_data->title}}</h4>
              <hr>
              <div class="row">
              <div class="col-md-12">
                  <p class="text-justify">{{$noties_data->note}}
                  </p>

                  <p class="text-justify"><a href="{{$noties_data->link1}}">{{$noties_data->link1}}</a></p>
                  <p class="text-justify"><a href="{{$noties_data->link2}}">{{$noties_data->link2}}</a></p>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <a href="/cc/career_counsellor_dashbord/noties"><i class="fas fa-arrow-circle-left"></i> Back to Notices</a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          ...
          <div class="text-center">
            <a href="/cc/career_counsellor_dashbord/noties/view/{{$noties_data->attachment}}" class="btn blue-gradient btn m-0">Download
              Attachment</a>
          </div>
        </div>
        @else
        <div class="col-md-4">
          ...
          <div class="text-center">
            <a href="#" class="btn blue-gradient btn m-0">Empty
              Attachment</a>
          </div>
        </div>
